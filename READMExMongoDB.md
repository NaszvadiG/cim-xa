...
1. Update the config file -- mongodb.php to your /application/config folder.

2. Autoload the library or include it in one of your controllers at run time.

3. Interact with the database using many of the active record functions that CodeIgniter provides.
